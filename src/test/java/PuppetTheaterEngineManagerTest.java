...
public class PuppetTheaterEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PuppetTheaterEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PuppetTheater/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PuppetTheater/InitOutcome.xml").getDocumentElement();
